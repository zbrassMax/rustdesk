...
pub const RENDEZVOUS_SERVERS: &[&str] = &["60.223.235.98"];
pub const PUBLIC_RS_PUB_KEY: &str = "11PpI3EmwD93pDSaaIoY8FmRp3n4wiPMXnOiz855VVR6n6cSM2vnLOJ/JvgdFCh/kDrlmICjlEU+oRN3nGx2Vw==";
